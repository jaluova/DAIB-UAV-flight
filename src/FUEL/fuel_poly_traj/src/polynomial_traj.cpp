#include <iostream>
#include <fuel_poly_traj/polynomial_traj.h>

namespace fuel_planner {
void PolynomialTraj::waypointsTraj(const Eigen::MatrixXd& positions, const Eigen::Vector3d& start_vel,
  ...
  //   double ts = times(i);
  //   fuel_poly_traj.addSegment(cx, cy, cz, ts);
  // }

  // return fuel_poly_traj;
}
...
//   fuel_poly_traj.addSegment(cx, cy, cz, t1);
...
//   fuel_poly_traj.addSegment(cx, cy, cz, t2);
...
//   fuel_poly_traj.addSegment(cx, cy, cz, t3);
...
//   fuel_poly_traj.addSegment(cx, cy, cz, t4);
...
//   fuel_poly_traj.addSegment(cx, cy, cz, t5);
...
//   fuel_poly_traj.addSegment(cx, cy, cz, t6);
...
//   fuel_poly_traj.addSegment(cx, cy, cz, t7);
...
//   fuel_poly_traj.addSegment(cx, cy, cz, t_ht);
...
//   fuel_poly_traj.addSegment(cx, cy, cz, t_m);
