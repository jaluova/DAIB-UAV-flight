...
public:
  ...
  void updateESDF3d();
  // Complete the occupancy update after inputPointCloud().  The upstream
  // implementation kept this behind MapROS; the DAIB bridge feeds a world
  // frame cloud directly, so it needs the same public step.
