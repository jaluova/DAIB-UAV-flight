...
#include <fuel_plan_env/obj_predictor.h>
#include <fuel_poly_traj/polynomial_traj.h>
#include <ros/ros.h>
#include <vector>
#include <visualization_msgs/Marker.h>
#include <fuel_active_perception/traj_visibility.h>
...
public:
  ...
  void drawPolynomialTraj(PolynomialTraj fuel_poly_traj, double resolution, const Eigen::Vector4d& color,
                          int id = 0);
